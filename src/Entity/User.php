...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
     ...
     * @ORM\Column(type="integer")
     */
    private $numeroCarteNationalIdentite;
    ...
    public function getNumeroCarteEtudiant(): ?string
    {
        return $this->numeroCarteEtudiant;
    }

    public function setNumeroCarteEtudiant(string $numeroCarteEtudiant): self
    {
    ...
    public function getNumeroCarteNationalIdentite(): ?int
    {
        return $this->numeroCarteNationalIdentite;
    }

    public function setNumeroCarteNationalIdentite(int $numeroCarteNationalIdentite): self
    {
        $this->numeroCarteNationalIdentite = $numeroCarteNationalIdentite;
